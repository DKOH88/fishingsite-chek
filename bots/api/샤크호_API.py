...
# =============================================================================
# 🚀 샤크호 API(Packet) 봇 - (좌석 선택 활성화 + GUI 연동)
# =============================================================================
#
# [설명]
# Requests(패킷) 방식으로 '샤크호'를 예약합니다.
# **좌석 선택**: AJAX 좌석 조회 후 선호 좌석을 선택합니다.
# **GUI 연동**: launcher로부터 설정 파일 경로를 인자로 받아 동적으로 실행됩니다.
#
# [사용법]
# python "샤크호_API.py" --config [config_file_path]
# =============================================================================

# 1. 샤크호 기본 정보 (yamujinfishing.com / v5.2_seat1)
BASE_URL = "http://www.yamujinfishing.com/_core/module/reservation_boat_v5.2_seat1"
PA_N_UID = "3348"  # 샤크호 고유 ID
...
def build_session():
    ...
    s.headers.update({
        ...
        "Origin": "http://www.yamujinfishing.com"
    })
...
def do_reservation(session, date, job):
    ...
    payload = [
        ("action", "insert"),
        ("link", f"/_core/module/reservation_boat_v5.2_seat1/popu2.step2.php"), 
        ("temp_bi_stat", "확인"),
        ("date", date),
        ("PA_N_UID", PA_N_UID),
        ("PH_N_UID", ph_n_uid),
