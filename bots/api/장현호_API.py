...
# 1. 장현호 기본 정보 (namdangfishing.com / v5.2_seat1)
BASE_URL = "http://www.namdangfishing.com/_core/module/reservation_boat_v5.2_seat1"
PA_N_UID = "560"  # 장현호 고유 ID
...
def build_session():
    ...
    s.headers.update({
        ...
        "Origin": "http://www.namdangfishing.com"
    })
...
def do_reservation(session, date, job):
    ...
    payload = [
        ("action", "insert"),
        ("link", f"%2F_core%2Fmodule%2Freservation_boat_v5.2_seat1%2Fpopu2.step2.php"), 
        ("temp_bi_stat", "확인"),
        ("date", date),
        ("PA_N_UID", PA_N_UID),
        ("PH_N_UID", ph_n_uid),
