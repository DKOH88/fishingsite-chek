...
PORTS = {
    "오천항": {
        "가즈아호": "가즈아호_Bot.py", "금땡이호": None, "꽃돼지호": None, "나폴리(신조선)": None, 
        "나폴리2": None, "나폴리7": None, "뉴나폴리": None, "빅보스호": None, 
        "싸부호": None, "오디세이호": None, "자이언트호": None, "카즈미호": None, 
        "팀바이트호": None, "프랜드호": None, "프린스호": None, "호랭이호": None
    },
    "삼길포항": {
...
class FishingLauncher:
    ...
    def create_widgets(self):
        ...
        for i in range(4):
            ...
            ttk.Label(f_slot, text="일").pack(side="left")
        ...
        self.cb_person = ttk.Combobox(self.lf_config, values=[str(i) for i in range(1, 5)], width=5, state="readonly")
        self.cb_person.set("1")
        self.cb_person.grid(row=5, column=1, sticky="w", padx=5)
    ...
    def save_config(self, silent=False):
        ...
        data = {
            ...
            "person_count": self.cb_person.get(),
